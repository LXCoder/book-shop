(function ($) {
	...
	$('.brand-logo-slider-container').each(function () {
		...
		$this.slick({
			...
			autoplay: true,
			rows: $row,
			prevArrow: '<button class="slick-prev" type="button"><i class="lnr lnr-chevron-left"></i></button>',
			nextArrow: '<button class="slick-next" type="button"><i class="lnr lnr-chevron-right"></i></button>',
			responsive: [{
				breakpoint: 1499,
				settings: {
					slidesToShow: 5,
